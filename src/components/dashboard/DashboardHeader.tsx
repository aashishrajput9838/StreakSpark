...
const DashboardHeader: React.FC<DashboardHeaderProps> = ({ onAddHabit }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-6 shadow flex flex-col gap-4">
      ...
      <button className="bg-white border border-orange-200 text-orange-700 font-semibold rounded-lg px-4 py-2 w-full mt-2 hover:bg-orange-50 transition">Browse Popular Habits</button>
