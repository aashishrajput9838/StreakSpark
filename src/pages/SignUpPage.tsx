    ...
    <div className="min-h-screen flex items-center justify-center p-4" style={{
      ...
      <div className="relative bg-white bg-opacity-70 backdrop-filter backdrop-blur-lg rounded-3xl shadow-xl p-8 w-full max-w-md mx-auto flex flex-col items-center">
        ...
        <div className="mt-8 text-center">
          <h1 className="text-2xl font-bold text-gray-800 mb-2">Sign up with email</h1>
          <p className="text-gray-600 text-sm mb-6">Create your StreakSpark account to build and track positive habits. For free.</p>
        </div>
